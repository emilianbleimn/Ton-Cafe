<?php
/* ══════════════════════════════════════════════════════════
   RECHTSTEXT ALS EIGENE SEITE
   ══════════════════════════════════════════════════════════
   Zeigt Impressum oder Datenschutzerklaerung unter einer
   eigenen Adresse an — ohne Raute, damit der Link sich
   ueberall eintragen laesst (PayPal, Google, Instagram).

   Wichtig: Diese Seite haelt KEINE eigene Kopie des Textes.
   Sie liest ihn bei jedem Aufruf aus der index.html. Damit
   gibt es den Rechtstext nur ein einziges Mal. Wird er dort
   geaendert, aendert er sich hier automatisch mit — die
   beiden Fassungen koennen gar nicht auseinanderlaufen.

   Aufgerufen wird diese Datei nicht direkt, sondern ueber
   impressum.php und datenschutz.php.
══════════════════════════════════════════════════════════ */

if (!isset($rechtstext_id)) {
